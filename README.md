...
* **Windows 용 설치 파일**: [다운로드(개발중)](https://github.com/joonhochoi/activeetfs/releases/latest/download/activeetfs_0.3.2_x64-setup.exe)
...
* **macOS 용 설치 파일 (Universal)**: [다운로드(개발중)](https://github.com/joonhochoi/activeetfs/releases/latest/download/activeetfs_0.3.2_universal.dmg)
