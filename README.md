...
![Active ETFs](https://img.shields.io/badge/version-0.3.6-blue.svg)
...
* **Windows 용 설치 파일**: [다운로드](https://github.com/joonhochoi/activeetfs/releases/latest/download/activeetfs_0.3.6_x64-setup.exe)
...
* **macOS 용 설치 파일 (Universal)**: [다운로드](https://github.com/joonhochoi/activeetfs/releases/latest/download/activeetfs_0.3.6_universal.dmg)
